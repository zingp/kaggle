 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "DecisionTree能否容忍空值？ CART(ID3,C4.5基本不用)基于空间的划分\n",
    "DNN？基于数值计算"
   ]
  },
  {
   ...
   "metadata": {},
   "source": [
    "# 查看dataFrame的数据类型与空值表现\n",
    "    第一步往往是空值的填充与Outlier的清洗"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "#train.isnull().count() # count与sum的区别，sum会将true=1的都加起来，false=1的不计算。count都会加？"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "1431  1432         120       RL    70.049958     4928   Pave   NaN      IR1   \n",
       ...
       "1441  1442         120       RM    70.049958     4426   Pave   NaN      Reg   \n",
       "1442  1443          60       FV    85.000000    11003   Pave   NaN      Reg   \n",
       "1443  1444          30       RL    70.049958     8854   Pave   NaN      Reg   \n",
       "1444  1445          20       RL    63.000000     8500   Pave   NaN      Reg   \n",
       "1445  1446          85       RL    70.000000     8400   Pave   NaN      Reg   \n",
       "1446  1447          20       RL    70.049958    26142   Pave   NaN      IR1   \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "7        8          60       RL    70.049958    10382   Pave  None      IR1   \n",
       ...
       "12      13          20       RL    70.049958    12968   Pave  None      IR2   \n",
       "13      14          20       RL    91.000000    10652   Pave  None      IR1   \n",
       "14      15          20       RL    70.049958    10920   Pave  None      IR1   \n",
       "15      16          45       RM    51.000000     6120   Pave  None      Reg   \n",
       "16      17          20       RL    70.049958    11241   Pave  None      IR1   \n",
       ...
       "24      25          20       RL    70.049958     8246   Pave  None      IR1   \n",
       ...
       "...    ...         ...      ...          ...      ...    ...   ...      ...   \n",
       "1430  1431          60       RL    60.000000    21930   Pave  None      IR3   \n",
       "1431  1432         120       RL    70.049958     4928   Pave  None      IR1   \n",
       "1432  1433          30       RL    60.000000    10800   Pave  Grvl      Reg   \n",
       "1433  1434          60       RL    93.000000    10261   Pave  None      IR1   \n",
       "1434  1435          20       RL    80.000000    17400   Pave  None      Reg   \n",
       "1435  1436          20       RL    80.000000     8400   Pave  None      Reg   \n",
       "1436  1437          20       RL    60.000000     9000   Pave  None      Reg   \n",
       "1437  1438          20       RL    96.000000    12444   Pave  None      Reg   \n",
       "1438  1439          20       RM    90.000000     7407   Pave  None      Reg   \n",
       "1439  1440          60       RL    80.000000    11584   Pave  None      Reg   \n",
       "1440  1441          70       RL    79.000000    11526   Pave  None      IR1   \n",
       "1441  1442         120       RM    70.049958     4426   Pave  None      Reg   \n",
       "1442  1443          60       FV    85.000000    11003   Pave  None      Reg   \n",
       "1443  1444          30       RL    70.049958     8854   Pave  None      Reg   \n",
       "1444  1445          20       RL    63.000000     8500   Pave  None      Reg   \n",
       "1445  1446          85       RL    70.000000     8400   Pave  None      Reg   \n",
       "1446  1447          20       RL    70.049958    26142   Pave  None      IR1   \n",
       "1447  1448          60       RL    80.000000    10000   Pave  None      Reg   \n",
       "1448  1449          50       RL    70.000000    11767   Pave  None      Reg   \n",
       "1449  1450         180       RM    21.000000     1533   Pave  None      Reg   \n",
       "1450  1451          90       RL    60.000000     9000   Pave  None      Reg   \n",
       "1451  1452          20       RL    78.000000     9262   Pave  None      Reg   \n",
       "1452  1453         180       RM    35.000000     3675   Pave  None      Reg   \n",
       "1453  1454          20       RL    90.000000    17217   Pave  None      Reg   \n",
       "1454  1455          20       FV    62.000000     7500   Pave  Pave      Reg   \n",
       "1455  1456          60       RL    62.000000     7917   Pave  None      Reg   \n",
       "1456  1457          20       RL    85.000000    13175   Pave  None      Reg   \n",
       "1457  1458          70       RL    66.000000     9042   Pave  None      Reg   \n",
       "1458  1459          20       RL    68.000000     9717   Pave  None      Reg   \n",
       "1459  1460          20       RL    75.000000     9937   Pave  None      Reg   \n",
       "\n",
       "     LandContour Utilities    ...     PoolArea PoolQC  Fence MiscFeature  \\\n",
       "0            Lvl    AllPub    ...            0   None   None        None   \n",
       "1            Lvl    AllPub    ...            0   None   None        None   \n",
       "2            Lvl    AllPub    ...            0   None   None        None   \n",
       "3            Lvl    AllPub    ...            0   None   None        None   \n",
       "4            Lvl    AllPub    ...            0   None   None        None   \n",
       "5            Lvl    AllPub    ...            0   None  MnPrv        Shed   \n",
       "6            Lvl    AllPub    ...            0   None   None        None   \n",
       "7            Lvl    AllPub    ...            0   None   None        Shed   \n",
       "8            Lvl    AllPub    ...            0   None   None        None   \n",
       "9            Lvl    AllPub    ...            0   None   None        None   \n",
       "10           Lvl    AllPub    ...            0   None   None        None   \n",
       "11           Lvl    AllPub    ...            0   None   None        None   \n",
       "12           Lvl    AllPub    ...            0   None   None        None   \n",
       "13           Lvl    AllPub    ...            0   None   None        None   \n",
       "14           Lvl    AllPub    ...            0   None   GdWo        None   \n",
       "15           Lvl    AllPub    ...            0   None  GdPrv        None   \n",
       "16           Lvl    AllPub    ...            0   None   None        Shed   \n",
       "17           Lvl    AllPub    ...            0   None   None        Shed   \n",
       "18           Lvl    AllPub    ...            0   None   None        None   \n",
       "19           Lvl    AllPub    ...            0   None  MnPrv        None   \n",
       "20           Lvl    AllPub    ...            0   None   None        None   \n",
       "21           Bnk    AllPub    ...            0   None  GdPrv        None   \n",
       "22           Lvl    AllPub    ...            0   None   None        None   \n",
       "23           Lvl    AllPub    ...            0   None   None        None   \n",
       "24           Lvl    AllPub    ...            0   None  MnPrv        None   \n",
       "25           Lvl    AllPub    ...            0   None   None        None   \n",
       "26           Lvl    AllPub    ...            0   None   None        None   \n",
       "27           Lvl    AllPub    ...            0   None   None        None   \n",
       "28           Lvl    AllPub    ...            0   None   None        None   \n",
       "29           Lvl    AllPub    ...            0   None   None        None   \n",
       "...          ...       ...    ...          ...    ...    ...         ...   \n",
       "1430         Lvl    AllPub    ...            0   None   None        None   \n",
       "1431         Lvl    AllPub    ...            0   None   None        None   \n",
       "1432         Lvl    AllPub    ...            0   None   None        None   \n",
       "1433         Lvl    AllPub    ...            0   None   None        None   \n",
       "1434         Low    AllPub    ...            0   None   None        None   \n",
       "1435         Lvl    AllPub    ...            0   None  GdPrv        None   \n",
       "1436         Lvl    AllPub    ...            0   None   GdWo        None   \n",
       "1437         Lvl    AllPub    ...            0   None   None        None   \n",
       "1438         Lvl    AllPub    ...            0   None  MnPrv        None   \n",
       "1439         Lvl    AllPub    ...            0   None   None        None   \n",
       "1440         Bnk    AllPub    ...            0   None   None        None   \n",
       "1441         Lvl    AllPub    ...            0   None   None        None   \n",
       "1442         Lvl    AllPub    ...            0   None   None        None   \n",
       "1443         Lvl    AllPub    ...            0   None   None        None   \n",
       "1444         Lvl    AllPub    ...            0   None   None        None   \n",
       "1445         Lvl    AllPub    ...            0   None   None        None   \n",
       "1446         Lvl    AllPub    ...            0   None   None        None   \n",
       "1447         Lvl    AllPub    ...            0   None   None        None   \n",
       "1448         Lvl    AllPub    ...            0   None   GdWo        None   \n",
       "1449         Lvl    AllPub    ...            0   None   None        None   \n",
       "1450         Lvl    AllPub    ...            0   None   None        None   \n",
       "1451         Lvl    AllPub    ...            0   None   None        None   \n",
       "1452         Lvl    AllPub    ...            0   None   None        None   \n",
       "1453         Lvl    AllPub    ...            0   None   None        None   \n",
       "1454         Lvl    AllPub    ...            0   None   None        None   \n",
       "1455         Lvl    AllPub    ...            0   None   None        None   \n",
       "1456         Lvl    AllPub    ...            0   None  MnPrv        None   \n",
       "1457         Lvl    AllPub    ...            0   None  GdPrv        Shed   \n",
       "1458         Lvl    AllPub    ...            0   None   None        None   \n",
       "1459         Lvl    AllPub    ...            0   None   None        None   \n",
       "\n",
       "     MiscVal MoSold YrSold  SaleType  SaleCondition  SalePrice  \n",
       "0          0      2   2008        WD         Normal     208500  \n",
       "1          0      5   2007        WD         Normal     181500  \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "目前的训练集噪声很大,留给后面的EDA(Exploria Data Analysis 探索性数据分析)过程"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "X=pd.get_dummies(train1)  # 获取训练集？变成结构化数据了One-Hot\n",
    "X.head()"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "# \n",
    "xg_reg=xgb.XGBRegressor(objective='reg:linear',colsample_bytree=0.6,learning_rate=0.01,max_depth=8,alpha=10,n_estimators=700,subsample=0.7)"
   ]
  },
  {
   "cell_type": "code",
